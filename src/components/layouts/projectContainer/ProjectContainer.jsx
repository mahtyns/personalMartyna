    ...
    <div className="projectPanelContainer">
      <div className="projectPanelWrapper">
        ...
        <div className="projectDescription">
          <ProjectDescription projectName={projectsAbout[1].project_name} projectYear={projectsAbout[1].project_year} projectDescr={projectsAbout[1].project_description} projectLinkSource={projectsAbout[1].project_link} projectLinkName={'Project Page at Behance'}/>
        </div>
      </div>
    </div>
  )
