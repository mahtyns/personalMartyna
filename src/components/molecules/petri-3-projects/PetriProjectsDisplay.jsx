    ...
    return (
        <div className="petrisBehind">
            <ProjectPetri
                ...
                projectImageSrc={props.projectsPetri[props.indexArray[0]].project_src}/>
            <ProjectPetri
                projectPetriAlt="Next Project"
                projectImageSrc={props.projectsPetri[props.indexArray[2]].project_src}/>
