export const projectsAbout = [{
    ...
    project_description: 'A React Project for a Cosmetic Ecommerce store. Contains Main Page, Product Page, About us, Contact and Cart page. Working with hooks and functional components. You can and remove products from cart, choose delivery method and go to the summary page.',
...
},
{
    ...
    project_description: 'A simple HTML5, CSS3 Project - a webpage for a Wine Store with wine courses available. Page with best products, reservation module and testimonials. The Domestika course contained basics of CSS animations, some advanced CSS styling and responsive design with Media Queries.',
...
},
{
    ...
    project_description: 'A popular game where you have to find a missing word. You guess the word by letters, but if you do not get the letter right, the hangman is being drawn.',
    project_type: 'programming',
...
},
{
    ...
    project_description: 'Webpage redesign for www.sarais.us, a shop with spreads. Added new modules: best recipes, reviews with the product link, newsletter subscription. Design both for desktop and mobile.',
    project_type: 'designUI',
    project_stack: ['Figma', 'Photoshop', 'Illustrator'],
    project_category: 'Design',
    project_status: 'Finished',
...
},
{
    ...
    project_description: 'The players are presented with a "cool" weekend plan and have to find an excuse not to go in 15 seconds.',
    project_type: 'programming',
